...
import imgMotrixTracker from './6b2873496b12d0795d5057ac2ad8c2ba.png';
import imgMotrixTrackerApply from './4539263dc303303b268705ec514bb8dc.png';
import imgDandanRes1 from './staticSHCfbDioioi5F1xlyT4cATR2nbe.png';
import imgDandanRes2 from './staticVvcVb5C7JouFrMx2Cjuc5bj0nGe.png';
import imgDandanDanmaku1 from './staticVdWIb5LMGobj9qxlDUQcUJDJnX7.png';
import imgDandanDanmaku2 from './staticAOyzbZzJ1o4w9YxVZTIcIAHJn3d.png';
...
| 名称         | 平台           | 特点                                                    | 网址                                                       |
| :----------- | :------------- | :------------------------------------------------------ | :--------------------------------------------------------- |
| 稀饭动漫     | 网页端+手机APP | 资源更新较及时、质量较高<br />有弹幕系统                      | https://稀饭动漫.com/<br />https://xifan.moe/ |
...
1. 下载安装好以后，在设置>进阶设置中勾选 **每天自动更新Tracker服务器** ，然后在 **Tracker服务器** 下拉栏中勾选所有选项，点击右侧 **更新按钮** 等待更新完成。最后 **保存并应用**
    ...
    <figure style={{display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap'}}>
      <Image src={imgMotrixTracker} alt="Motrix Tracker设置" style={{width: '48%', minWidth: '240px'}} />
      <Image src={imgMotrixTrackerApply} alt="Motrix 保存并应用" style={{width: '48%', minWidth: '240px'}} />
    </figure>
...
<figure style={{display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap'}}>
  <Image src={imgDandanRes1} alt="弹弹play资源管理1" style={{width: '48%', minWidth: '240px'}} />
  <Image src={imgDandanRes2} alt="弹弹play资源管理2" style={{width: '48%', minWidth: '240px'}} />
</figure>

- 弹弹 play的招牌功能是独立的弹幕生态和全网弹幕爬取，如下图，可以集合哔哩哔哩、巴哈姆特等多个平台的弹幕，加上较为完善的弹幕个性化、弹幕屏蔽功能，极大丰富了追番体验

<figure style={{display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap'}}>
  <Image src={imgDandanDanmaku1} alt="弹弹play弹幕功能1" style={{width: '48%', minWidth: '240px'}} />
  <Image src={imgDandanDanmaku2} alt="弹弹play弹幕功能2" style={{width: '48%', minWidth: '240px'}} />
</figure>
